...
thresholds_data %>%
  ...
  ggplot(aes(x = depth_stream, y = compression_ratio, fill = type)) +
  geom_col(position = "dodge") +
  labs(x = "Depth Stream", y = "Compression Ratio", fill = "Change Threshold") +
  geom_text(aes(label = label), position = position_dodge(0.9), vjust = -0.4) +
  theme(legend.position = "bottom")
...
thresholds_data %>%
  ...
  ggplot(aes(x = depth_stream, y = average_compression_time, fill = type)) +
  geom_col(position = "dodge") +
  labs(x = "Depth Stream", y = "Average Compression Time (ms)", fill = "Change Threshold") +
  geom_text(aes(label = label), position = position_dodge(0.9), vjust = -0.4) +
  theme(legend.position = "bottom")
...
thresholds_data %>%
  ...
  ggplot(aes(x = depth_stream, y = average_decompression_time, fill = type)) +
  geom_col(position = "dodge") +
  labs(x = "Depth Stream", y = "Average Decompression Time (ms)", fill = "Change Threshold") +
  geom_text(aes(label = label), position = position_dodge(0.9), vjust = -0.4) +
  theme(legend.position = "bottom")
...
thresholds_data %>%
  ...
  ggplot(aes(x = depth_stream, y = average_psnr, fill = type)) +
  geom_col(position = "dodge") +
  labs(x = "Depth Stream", y = "Average PSNR", fill = "Change Threshold") +
  geom_text(aes(label = label), position = position_dodge(0.9), vjust = -0.4) +
  theme(legend.position = "bottom")
```
